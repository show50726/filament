...
void View::setOitOptions(OitOptions options) noexcept { downcast(this)->setOitOptions(options); }

OitOptions View::getOitOptions() const noexcept { return downcast(this)->getOitOptions(); }
