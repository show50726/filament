...
FMaterialInstance* FMaterial::createInstance(const char* name) const noexcept {
    bool useUboBatching = mEngine.features.material.enable_material_instance_uniform_batching &&
                          getMaterialDomain() == MaterialDomain::SURFACE;
